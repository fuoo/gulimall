<template>
  <el-dialog
    ...
    <el-form-item label="鏀惰揣浜�" prop="consignee">
      <el-input v-model="dataForm.consignee" placeholder="鏀惰揣浜�"></el-input>
    </el-form-item>
    <el-form-item label="鏀惰揣浜虹數璇�" prop="consigneeTel">
      <el-input v-model="dataForm.consigneeTel" placeholder="鏀惰揣浜虹數璇�"></el-input>
    </el-form-item>
    <el-form-item label="閰嶉�佸湴鍧�" prop="deliveryAddress">
      <el-input v-model="dataForm.deliveryAddress" placeholder="閰嶉�佸湴鍧�"></el-input>
    </el-form-item>
    <el-form-item label="璁㈠崟澶囨敞" prop="orderComment">
      <el-input v-model="dataForm.orderComment" placeholder="璁㈠崟澶囨敞"></el-input>
    </el-form-item>
    <el-form-item label="浠樻鏂瑰紡銆� 1:鍦ㄧ嚎浠樻 2:璐у埌浠樻銆�" prop="paymentWay">
      <el-input v-model="dataForm.paymentWay" placeholder="浠樻鏂瑰紡銆� 1:鍦ㄧ嚎浠樻 2:璐у埌浠樻銆�"></el-input>
    </el-form-item>
    <el-form-item label="浠诲姟鐘舵��" prop="taskStatus">
      <el-input v-model="dataForm.taskStatus" placeholder="浠诲姟鐘舵��"></el-input>
    </el-form-item>
    <el-form-item label="璁㈠崟鎻忚堪" prop="orderBody">
      <el-input v-model="dataForm.orderBody" placeholder="璁㈠崟鎻忚堪"></el-input>
    </el-form-item>
    <el-form-item label="鐗╂祦鍗曞彿" prop="trackingNo">
      <el-input v-model="dataForm.trackingNo" placeholder="鐗╂祦鍗曞彿"></el-input>
    </el-form-item>
    ...
    <el-form-item label="宸ヤ綔鍗曞娉�" prop="taskComment">
      <el-input v-model="dataForm.taskComment" placeholder="宸ヤ綔鍗曞娉�"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          consignee: [
            { required: true, message: '鏀惰揣浜�不能为空', trigger: 'blur' }
          ],
          consigneeTel: [
            { required: true, message: '鏀惰揣浜虹數璇�不能为空', trigger: 'blur' }
          ],
          deliveryAddress: [
            { required: true, message: '閰嶉�佸湴鍧�不能为空', trigger: 'blur' }
          ],
          orderComment: [
            { required: true, message: '璁㈠崟澶囨敞不能为空', trigger: 'blur' }
          ],
          paymentWay: [
            { required: true, message: '浠樻鏂瑰紡銆� 1:鍦ㄧ嚎浠樻 2:璐у埌浠樻銆�不能为空', trigger: 'blur' }
          ],
          taskStatus: [
            { required: true, message: '浠诲姟鐘舵��不能为空', trigger: 'blur' }
          ],
          orderBody: [
            { required: true, message: '璁㈠崟鎻忚堪不能为空', trigger: 'blur' }
          ],
          trackingNo: [
            { required: true, message: '鐗╂祦鍗曞彿不能为空', trigger: 'blur' }
          ],
          createTime: [
          ...
          taskComment: [
            { required: true, message: '宸ヤ綔鍗曞娉�不能为空', trigger: 'blur' }
          ]
        }
      }
    },
