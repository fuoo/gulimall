<template>
  <el-dialog
    ...
    <el-form-item label="璐拱涓暟" prop="skuNum">
      <el-input v-model="dataForm.skuNum" placeholder="璐拱涓暟"></el-input>
    </el-form-item>
    <el-form-item label="宸ヤ綔鍗昳d" prop="taskId">
      <el-input v-model="dataForm.taskId" placeholder="宸ヤ綔鍗昳d"></el-input>
    </el-form-item>
    <el-form-item label="浠撳簱id" prop="wareId">
      <el-input v-model="dataForm.wareId" placeholder="浠撳簱id"></el-input>
    </el-form-item>
    <el-form-item label="1-宸查攣瀹�  2-宸茶В閿�  3-鎵ｅ噺" prop="lockStatus">
      <el-input v-model="dataForm.lockStatus" placeholder="1-宸查攣瀹�  2-宸茶В閿�  3-鎵ｅ噺"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          skuNum: [
            { required: true, message: '璐拱涓暟不能为空', trigger: 'blur' }
          ],
          taskId: [
            { required: true, message: '宸ヤ綔鍗昳d不能为空', trigger: 'blur' }
          ],
          wareId: [
            { required: true, message: '浠撳簱id不能为空', trigger: 'blur' }
          ],
          lockStatus: [
            { required: true, message: '1-宸查攣瀹�  2-宸茶В閿�  3-鎵ｅ噺不能为空', trigger: 'blur' }
          ]
        }
      }
    },
